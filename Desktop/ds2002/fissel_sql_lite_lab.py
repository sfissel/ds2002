...
#create variable cur to hold cursor object
cur = conn.cursor()
...
#add more users by creating new variable
...
#use executemany function to load new data into database
...
#delete any user with last name 'Parker'
